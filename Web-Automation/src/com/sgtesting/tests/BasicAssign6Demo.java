...
public class BasicAssign6Demo {
	...
	private static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.findElement(By.xpath("//*[@id='taskListBlock']/div[4]/div[1]/div[2]/div[2]/div/div[1]")).clear();
			Thread.sleep(1000);
			oBrowser.findElement(By.xpath("//*[@id='taskListBlock']/div[4]/div[1]/div[2]/div[2]/div/div[1]")).sendKeys("Modify Project");
			Thread.sleep(1000);
