...
public class BasicAssign4Demo {
	...
	private static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.findElement(By.xpath("//*[@id='customerLightBox_nameField']")).sendKeys("TestUser1");
			Thread.sleep(1000);
	...
	private static void modifyCustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id='taskListBlock']/div[2]/div[1]/div[3]/div")).sendKeys("Modify Customer");
			Thread.sleep(4000);
